...
![pipe](https://user-images.githubusercontent.com/18303573/104558511-42b9a080-5686-11eb-9522-2941b3923423.png)

In order to comprise the dataset from January 2020 to December 2020, we built the pipeline with three steps. First, we crawled the labeled claim data from \textit{Politifact}\footnote{\url{https://www.politifact.com/}} and \textit{Snopes}\footnote{\url{https://www.snopes.com/}} using our own crawler. With the claims, we extracted the keywords in order to make the search query. Second, the generated search query was deployed through our Twitter\footnote{\url{https://twitter.com/home}} crawler to obtain the claim propagation features. Finally, we supplemented the user information using Twitter API, Tweepy\footnote{\url{https://www.tweepy.org/}}.
